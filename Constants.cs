...
namespace iDash
{
    class Constants
    {
        ...
        {
            "hour.time",
            "m_speed.kmh.CarTelemetryData",
            "m_throttle.byte.CarTelemetryData",
            "m_steer.sbyte.CarTelemetryData",
            "m_gear.sbyte.CarTelemetryData",
            "m_brake.byte.CarTelemetryData",
            "m_clutch.ar.byte.CarTelemetryData",
            "m_engineRPM.ushort.CarTelemetryData",
            "m_drs.byte.CarTelemetryData",
            "m_revLightsPercent.byte.CarTelemetryData",
            "m_brakesTemperature.ushort[].CarTelemetryData",
            "m_tyresSurfaceTemperature.ushort[].CarTelemetryData",
            "m_tyresInnerTemperature.ushort[].CarTelemetryData",
            "m_engineTemperature.ushort.CarTelemetryData",
            "m_tyresPressure.float[].CarTelemetryData",
            "m_tractionControl.byte.CarStatusData",
            "m_antiLockBrakes.byte.CarStatusData",
            "m_fuelMix.byte.CarStatusData",
            "m_frontBrakeBias.byte.CarStatusData",
            "m_pitLimiterStatus.byte.CarStatusData",
            "m_fuelInTank.float.CarStatusData",
            "m_fuelCapacity.float.CarStatusData",
            "m_maxRPM.ushort.CarStatusData",
            "m_idleRPM.ushort.CarStatusData",
            "m_maxGears.byte.CarStatusData",
            "m_drsAllowed.byte.CarStatusData",
            "m_tyresWear.byte[].CarStatusData",
            "m_tyreCompound.byte.CarStatusData",
            "m_tyresDamage.byte[].CarStatusData",
            "m_frontLeftWingDamage.byte.CarStatusData",
            "m_frontRightWingDamage.byte.CarStatusData",
            "m_rearWingDamage.byte.CarStatusData",
            "m_engineDamage.byte.CarStatusData",
            "m_gearBoxDamage.byte.CarStatusData",
            "m_exhaustDamage.byte.CarStatusData",
            "m_vehicleFiaFlags.sbyte.CarStatusData",
            "m_ersStoreEnergy.float.CarStatusData",
            "m_ersDeployMode.byte.CarStatusData",
            "m_ersHarvestedThisLapMGUK.float.CarStatusData",
            "m_ersHarvestedThisLapMGUH.float.CarStatusData",
            "m_ersDeployedThisLap.float.CarStatusData",
            "m_lastLapTime.time.LapData",
            "m_currentLapTime.time.LapData",
            "m_bestLapTime.time.LapData",
            "m_sector1Time.time.LapData",
            "m_sector2Time.time.LapData",
            "m_lapDistance.float.LapData",
            "m_totalDistance.float.LapData",
            "m_safetyCarDelta.time.LapData",
            "m_carPosition.byte.LapData",
            "m_currentLapNum.byte.LapData",
            "m_pitStatus.byte.LapData",
            "m_sector.byte.LapData",
            "m_currentLapInvalid.byte.LapData",
            "m_penalties.byte.LapData",
            "m_gridPosition.byte.LapData",
            "m_driverStatus.byte.LapData",
            "m_resultStatus.byte.LapData"
        };
    }
}
